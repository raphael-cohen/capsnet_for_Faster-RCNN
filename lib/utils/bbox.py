...
def bbox_overlaps(boxes, query_boxes):
    ...
    # print('iw: ', iw)
    # print('ih: ', ih)
    # print('boxes: ', boxes)  # this is the nan one
    # print('box_areas: ', box_areas) # this is the nan one
    # print('query_areas: ', query_areas)
    overlaps = iw * ih / ua #(ua+1e-6) ### Added epsilon here to avoir nan returns
