...
CLASSES = ('__background__', 'car', 'laptop')
...
DATASETS = {
    'coco_2017_val': ('coco_2017_val', ),
    'coco_2017_train': ('coco_2017_train', ),
...
def vis_detections(im, class_name, dets, thresh=0.5):
    ...
    plt.tight_layout()
    plt.draw()
    plt.savefig('image_out/'+str(np.random.randint(1,9999))+'.jpg')
...
if __name__ == '__main__':
    ...
    saved_model = os.path.join(
        ...
        NETS[demonet][0] % (70000 if dataset == 'pascal_voc' else 125000))
    ...
    # 3 classes
    net.create_architecture(3, tag='default', anchor_scales=[4, 8, 16, 32])
    ...
    im_names = [f for f in listdir(join(cfg.DATA_DIR,'demo')) if isfile(join(cfg.DATA_DIR,'demo', f))]

    '''
    im_names = [
        '000456.jpg', '000542.jpg', '001150.jpg', '001763.jpg', '004545.jpg', '000000004495.jpg', '000000009483.jpg',
	'000000013659.jpg', '000000014226.jpg', '000000016439.jpg'
    ]
    '''
